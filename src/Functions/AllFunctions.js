...
// prettier-ignore
export const store_Register = async (naming, Status, Register, updateRegister, updateAlldata) => {
    if(Register === null) {
        if(Status) {
            if (Register === null && localStorage.getItem("Register") !== null) {
                console.log(`${naming} -> Register`)
                var all_data_dep = []
                var final_data = []
                var register_val = JSON.parse(localStorage.getItem("Register"));
                await axios.get(`http://localhost:5000/deposito/${register_val.Deposito_id}`).then(async (res) => {
                    await axios.get(`http://localhost:5000/deposito`).then((alldep) => {
                        all_data_dep = alldep.data
                    })
                    updateRegister(res.data[0])
                });
                final_data = all_data_dep.filter(ele => ele.Deposito_id_fk === register_val.Deposito_id)
                for(var i=0; i < final_data.length; i++) {
                    var emp = []
                    for(var j=0; j < all_data_dep.length; j++) {
                        if(all_data_dep[j].Deposito_id_fk === final_data[i].Deposito_id) {
                            emp.push(all_data_dep[j])
                        }
                    }
                    final_data[i].employees = emp
                }
                updateAlldata(final_data)
            }
        } else {
            if (window.desktop) {
                await window.api.getAllData("Register").then((item) => {
                    updateRegister(item.Register)
                });
            }
        }
    }
...
export const store_SalesActivity = async (naming, Status, Sales_Activity, allsalesactivity) => {
    if(Sales_Activity.length === 0) {
        if(Status) {
            await axios.get('https://storecontrolserver-production-3675.up.railway.app/salesactivity')
                .then(async item => {
                    ...
                    if(con === undefined && (log.Type === 'Manager' || log.Type === 'Master Manager')) {
                        ...
                        main_data = data
                        await axios.post('https://storecontrolserver-production-3675.up.railway.app/salesactivity/new', data)
                        ...
                        if(window.desktop) {
                            ...
                            await window.api.getAllData("Sales_Activity").then(async (item2) => {
                                if(item2.Sales_Activity === undefined) {
                                    ...
                                    await axios.post('https://storecontrolserver-production-3675.up.railway.app/salesactivity/new', another_data[another_data.length - 1])
                                }
                            })
                        }
                    } else {
...
export const store_Products = async (naming, Status, Products, allproduct, setAllPro, Sales_Activity, allorders, allsalesactivity, CategoryAdd=null, filtered_cat=null) => {
    if(Products.length === 0) {
        if(Status) {
            await axios.get("https://storecontrolserver-production-3675.up.railway.app/product").then(async (item) => {
                ...
                if(filtered_cat !== null) {
                    if(CategoryAdd.length === 0) {
                        await axios.get("https://storecontrolserver-production-3675.up.railway.app/category").then(async (category_data) => {
                    ...
                    await window.api.getAllData("Products").then(async (item2) => {
                        await window.api.getAllData("Orders_Returns").then(async (order_ret) => {
                            if(order_ret.Orders_Returns) {
                                ...
                                order_ret.Orders_Returns.forEach(async (ret) => {
                                    await axios.put('https://storecontrolserver-production-3675.up.railway.app/product/quantity', {Product_id: ret.Product_id, Stock: ret.Stock})
                                    ...
                                    console.log(ret)
                                    if(ret.del) {
                                        await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/ordermaster/delete/${ret.order.Order_id}`)
                                    } else {
                                        await axios.put(`https://storecontrolserver-production-3675.up.railway.app/ordermaster/price`, {
                                            Order_id: ret.order.Order_id,
                                            Total_price: ret.order.Total_price
                                        })
                                    }
                                    await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/orderproduct/delete/${ret.val.Order_pro_id}`)
                                    .then(async item => {
                                        await axios.get('https://storecontrolserver-production-3675.up.railway.app/ordermaster')
                                            .then(async prod => {
                                                let months_data = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
                                                ...
                                                await axios.put('https://storecontrolserver-production-3675.up.railway.app/salesactivity/day', {
                                                    Sales_id: Sales_data.Sales_id,
                                                    ...Sales_data
                                                })
                                                await axios.get('https://storecontrolserver-production-3675.up.railway.app/salesactivity').then(async item3 => {
                        ...
                        item2.Products.forEach(async function (pro, index) {
                            ...
                            if (!Object.keys(pro).includes('createdAt')) {
                                ...
                                await axios.post("https://storecontrolserver-production-3675.up.railway.app/product/new", convert_data).then(async (item) => {
                                ...
                                await axios.put('https://storecontrolserver-production-3675.up.railway.app/product/edit', edit_val).then(res => {
                        ...
                        await window.api.getAllData("Products_Returns").then(async (product_ret) => {
                            if(product_ret.Products_Returns) {
                                ...
                                product_ret.Products_Returns.forEach(async (ret) => {
                                    await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/product/delete/${ret.Product_id}`);
                                    await axios.get("https://storecontrolserver-production-3675.up.railway.app/product").then(async (item) => {
                        ...
                        //         }
                        //         if (flag === 0) {
                        //             await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/product/delete/${alldata[h].Product_id}`);
                        //             await axios.get("https://storecontrolserver-production-3675.up.railway.app/product").then(async (item) => {
                        //                 console.log(`${naming} -> Delete`)
                        //                 var alldata = item.data
                        //                 if (alldata.length > 0) {
...
export const store_Category = async (naming, Status, CategoryAdd, category) => {
    if(CategoryAdd.length === 0) {
        if(Status) {
            await axios.get("https://storecontrolserver-production-3675.up.railway.app/category").then(async (item) => {
                    ...
                    await window.api.getAllData("CategoryAdd").then(async (item2) => {
                        item2.CategoryAdd.forEach(async function (cate) {
                            if (!Object.keys(cate).includes('createdAt')) {
                                await axios.post('https://storecontrolserver-production-3675.up.railway.app/category/new', cate).then(async (item3) => {
                        ...
                        //             await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/category/delete/${c.Category_id}`)
                    ...
                    await window.api.getAllData("Category_Returns").then(async (category_ret) => {
                        if(category_ret.Category_Returns) {
                            category_ret.Category_Returns.forEach(async (ret) => {
                                await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/category/delete/${ret.Category_id}`)
...
export const store_Desposito = async (naming, Status, DepositoAdd, deposito) => {
    if (DepositoAdd.length === 0) {
        if (Status) {
            await axios.get("https://storecontrolserver-production-3675.up.railway.app/deposito").then(async (item) => {
...
export const store_Expenses = async (naming, Status, Expenses, allexp) => {
    if(Expenses.length === 0){
        if(Status) {
            await axios.get("https://storecontrolserver-production-3675.up.railway.app/expense").then(async (item) => {
                    ...
                    await window.api.getAllData("Expenses").then(async (item2) => {
                        item2.Expenses.forEach(async function (exp, index) {
                            if(!Object.keys(exp).includes('ExpenseId')) {
                                await axios.post("https://storecontrolserver-production-3675.up.railway.app/expense/new", exp)
                                .then(async (item3) => {
                            ...
                            if(deposit_client.length === item2.Expenses.length) {
                                item2.Expenses.forEach(async (new_exp) => {
                                    ...
                                    if(flag1 === 1) {
                                        ...
                                        await axios.put("https://storecontrolserver-production-3675.up.railway.app/expense/edit", new_exp).catch(err => console.log(err))
                                        await axios.get("https://storecontrolserver-production-3675.up.railway.app/expense").then(async (item3) => {
                            ...
                            //             await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/expense/delete/${ex.ExpenseId}`).then(async dele => {
                            //                 await axios.get("https://storecontrolserver-production-3675.up.railway.app/expense").then(async (item7) => {
                    ...
                    await window.api.getAllData("Expenses_Returns").then(async (expense_ret) => {
                        if(expense_ret.Expenses_Returns) {
                            expense_ret.Expenses_Returns.forEach(async (ret) => {
                                await axios.delete(`https://storecontrolserver-production-3675.up.railway.app/expense/delete/${ret.Expense_id}`).then(async dele => {
                                    await axios.get("https://storecontrolserver-production-3675.up.railway.app/expense").then(async (item7) => {
...
export const store_Expensecat = async (naming, Status, Expensecat, expense_category) => {
    if (Expensecat.length === 0) {
        if(Status) {
            await axios.get("https://storecontrolserver-production-3675.up.railway.app/expensecat").then(async (item) => {
                    ...
                    await window.api.getAllData("Expensecat").then(async (item2) => {
                        item2.Expensecat.forEach(async function (exp_cate, index) {
                            if(!Object.keys(exp_cate).includes('CategoryExpense_id')) {
                                await axios.post("https://storecontrolserver-production-3675.up.railway.app/expensecat/new", exp_cate).then(async (item3) => {
...
export const store_NotifyMaster = async (naming, Status, Notific, notify) => {
    if(Notific.length === 0){
        if(Status) {
            await axios.get("https://storecontrolserver-production-3675.up.railway.app/notification").then(async item => {
                    ...
                    await window.api.getAllData("Notification").then(async (item2) => {
                        item2.Notification.forEach(async notify_data => {
                            if(notify_data.Notify_id === undefined) {
                                await axios.post("https://storecontrolserver-production-3675.up.railway.app/notification/new",{
